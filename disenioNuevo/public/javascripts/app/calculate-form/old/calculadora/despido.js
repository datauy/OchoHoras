define(function (require) {
	...
	function calcularDespido(datos) {
		...
		console.log("SUELDO " + sueldo + " AGUINALDO " + aguinaldoMensual + " LIC " + licenciaMensual + " SALARIO VAC " + salarioVacMensual + " OTROS " + otrosIngresos);
		var ingresosMensualesTotales = sueldo + aguinaldoMensual + licenciaMensual + salarioVacMensual + otrosIngresos;
		console.log("INGRESOS TOTALES " + ingresosMensualesTotales + " AÑOS " + años);
